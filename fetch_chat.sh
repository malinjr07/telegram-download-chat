...
echo "AI_MODEL_ACADEMY"
uv run telegram-download-chat 4308260628 --subchat "General Chat"
uv run telegram-download-chat 4308260628 --subchat "Social Media Questions"

echo "AI_OFM_FRAMEWORK"
